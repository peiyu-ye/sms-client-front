...
import { FormItem, FormSchema } from "./form";
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const modelRef = reactive(
      props.formSchema.formItem.reduce(
